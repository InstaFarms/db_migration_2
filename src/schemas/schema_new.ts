...
export const propertyDetailView = pgView("propertyDetailView").as((qb) =>
    qb
        .select({
            ...
            rateTypeId: propertiesDataSpecificToBrands.rateTypeId,
            roomTypeId: propertiesDataSpecificToBrands.roomTypeId,
            ratePlanId: propertiesDataSpecificToBrands.ratePlanId,
            ...
            citySlug: sql<string>`${brandsOnCities.slug}`.as("citySlug"),
            state: states.state,
            city: cities.city,
            area: areas.area,
